...
>Also, we can find out the **Inverse Fourier Transform** in this expression. Doing the similar calculation in a fourier transformed function converts the frequency domain to a time domain back.
